...
import dev.iamspathan.realworldio.R.string
...
class MyFeedFragment : Fragment() {
    ...
    fun openArticle(articleId: String) {
        findNavController().navigate(R.id.action_myFeed_openArticle,
            bundleOf(resources.getString(string.arg_article_id) to articleId))
    }
